...
/**
 * Created by libin on 15/12/19.
 */
public class AliTest {
    private static String endpoint = "oss-cn-hangzhou.aliyuncs.com";
    private static String accessKeyId = "5lZcZQiP7MWD84oL";
    private static String accessKeySecret = "v0Ad5OlEcnjAZgXq8Pxyo0JHmVWvui";
